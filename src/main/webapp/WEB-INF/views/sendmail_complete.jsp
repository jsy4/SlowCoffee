			...
			<div class="full-height-tablecell">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="joinUs">
								<h1 style = "color:#CA965C;">Mail Sent!</h1><br/><br/>
								<h3>Temporary password is sent to your email.</h3>
								<h3>Please change the password ASAP in<br/><br/>(Mypage)->(Modify Member Information)</h3><br/><br/>
