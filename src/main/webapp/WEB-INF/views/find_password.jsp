	...
	<!-- end header -->
		...
		<div class="full-height-section error-section">
			<div class="full-height-tablecell">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center mt-150 mb-150 container">
							<div class="contact-form">
								<form action="mail.do">
									<h1 style = "color:#CA965C;">Finding lost password</h1><br/><br/>
									<h3>Please enter your id and email.</h3>
									<p><input type="text" placeholder="Id" name="id" id="id" required></p>
