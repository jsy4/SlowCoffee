			...
			<div class="full-height-tablecell">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="joinUs">
								<h1 style = "color:#CA965C;">Wrong Id/Email</h1><br/><br/>
								<h3>System doesn't have information you provided</h3>
								<h3>Try again with another ID and Email</h3><br/><br/>
								<a href="find_password.do" class="boxed-btn">Go to Find Password</a>
							</div>
						</div>
					</div>
				</div>
